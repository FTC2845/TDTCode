  ...
  public boolean xMoveDone =false;
    ...
    public int rot180ActualXposition;
    public int rot180ActualYposition;
    public int rot180XcompFactor=0;   
    public int rot180YcompFactor=0;  
...
public void driveTicksRelative(int xticks, int yticks,double xpower, double ypower,double targetAngle) {
 ...
 // This section is for longer moves, greater than 20 inches at higher speeds       
                ...
                xpwr = ((((currentVelocity - targetVelocity)* -.2) +.25)* xDirection);   // The power applied in final deceleration is dependent on the current velocity.
